        ...
        <div class="home-content">
            ...
            <div class="home-content-table">
                ...
                <div class="home-content-table_header">
                    ...
                    <!-- form create -->
                    <form action="?controller=category&action=create" method="POST" class="form-category"
                        id=form-category-create>
                    ...
                    <!-- Form update -->
                    <form method="POST" class="form-category" id="form-category-update" style="display: none;"
                        autocomplete="off">
                        <div class=" form-field">
